...
namespace GlobalDemo
{
    public partial class ModificarUsuario : Form
    {
        public ModificarUsuario()
        {
            ...
            lblFPIndex.Hide();
            cmbFPIndex.Hide();
            btnIniciarEnrolamientoModif.Hide();
            cBox1Huella.Hide();
            cBox2Huella.Hide();
            cBox3Huella.Hide();
        ...
        #region Parametros A Modificar

        string id, nombre, password, privilegio, numeroDeTarjeta;
        bool habilitado;
        public string IdAModificar
        {
            set { id = value; }
        }
        ...
        public string PasswordAModificar
        {
            set { password = value; }
        }
        public string PrivilegioUsuarioAModificar
        {
            set { privilegio = value; }
        }
        public bool HabilitadoAModificar
        {
            set { habilitado = value; }
        }

        public string NumeroTarjetaAModificar
        {
        ...
        private void ModificarUsuario_Load(object sender, EventArgs e)
        {
            ...
            cmbTipoDeUsuario.Text = privilegio;
            cBoxHabilitado.Checked = (habilitado) ? true : false;
            txtTarjeta.Text = numeroDeTarjeta;
        }
        ...
        private void btnModificarHuella_Click(object sender, EventArgs e)
        {
            if (txtID.Text.Length != 0 && txtID.Text.Trim().Length != 0)
            {
                if (MessageBox.Show("¿Los datos generales del Usuario estan correctos?", "Confirmar Datos", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    lblFPIndex.Show();
                    cmbFPIndex.Show();
                    btnIniciarEnrolamientoModif.Show();
                    btnModificarHuella.Hide();
                    cBox1Huella.Show();
                    cBox2Huella.Show();
                    cBox3Huella.Show();
        ...
        private void btnIniciarEnrolamientoModif_Click(object sender, EventArgs e)
        {
            ...
            btnIniciarEnrolamientoModif.Enabled = false;
        ...
        void dispositivo_OnFingerFeature(int iScore)//Al enrolar nuevo usuario, regresa la calidad de la huella enrolada
        {
            ...
            else
            {
                ...
                huellaEnrolada = 0;
                btnIniciarEnrolamientoModif.Enabled = true;
                lblHuellaEnrolada.Text = "Huellas detectadas: " + huellaEnrolada;
        ...
        private void btnModifUsuario_Click(object sender, EventArgs e)
        {
            ...
            if (dispositivo.SSR_SetUserInfo(iMachineNumber, userID, nombreUsuario, Password, tipoDeUsuario, usuarioHabilitado))
            {
                Cursor = Cursors.Default;
                MessageBox.Show("Usuario Modificado de forma exitosa", "Agregar Usuario", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.Close();
            }
            else
            {
